...
type UserServiceClient interface {
	...
	GetSingleUser(ctx context.Context, in *IdUser, opts ...grpc.CallOption) (*UserData, error)
}
...
func (c *userServiceClient) GetSingleUser(ctx context.Context, in *IdUser, opts ...grpc.CallOption) (*UserData, error) {
	out := new(UserData)
...
type UserServiceServer interface {
	// Declare an rpc for each method that is called via gRPC
	GetSingleUser(context.Context, *IdUser) (*UserData, error)
...
func (UnimplementedUserServiceServer) GetSingleUser(context.Context, *IdUser) (*UserData, error) {
...
func _UserService_GetSingleUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetSingleUser(ctx, req.(*IdUser))
	}
